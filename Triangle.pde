public class Triangle {
  ...
  private float xCoord3; //x3 coordinate of the flipper
  private float yCoord3;//y3 coordinate of the flipper
  ...
  public float getXCoord3() {  
    return xCoord3;
  }  // getter

  public float getYCoord3() {
    return yCoord3;
  }  //getter
  ...
  public void setXCoord3(float xCoord3) {
  ...
  public void setYCoord3(float yCoord3) {

    this.yCoord3 = yCoord3;
  }//setter
  ...
  public Triangle(float xCoord1, float yCoord1, float xCoord2, float yCoord2, float xCoord3, float yCoord3) {
    setXCoord1(xCoord1);
    setXCoord2(xCoord2);
    setXCoord3(xCoord3);
    setYCoord1(yCoord1);
    setYCoord2(yCoord2);
    setYCoord3(yCoord3);
  }//public triangle contructor which sets the x and y coordinates
}
